    ...
    <div className='flex flex-col flex-1 border-transparent'> 
      <div className='flex flex-col flex-1 justify-center px-4'> 
        <div className='max-w-3xl mx-auto w-full'> 
          ...
          {/* CHAT MESSAGES */}
          {messages.length > 0 && (
            <div className='flex flex-col flex-1 max-w-3xl mx-auto w-full mt-6 mb-32 px-4'>
          ...
          <form action="" className='mt-9 border-zinc-500 rounded-lg'> 
            <div className='relative w-full'> 

            <textarea id="main-input" className='bg-transparent border border-default-medium rounded-3xl h-28 
            focus:ring-brand focus:border-brand resize-none block w-full px-4 py-3 shadow-xs placeholder:text-body' 
            placeholder='Ask anything' rows={4} value={input} onChange={(e) => setInput(e.target.value)}> 
            </textarea> 
            
              <div className='absolute flex bottom-3 gap-2 w-full'>

                <button type='button' className="flex items-center rounded-3xl ml-4 border border-white px-2 py-1.5 text-white 
                hover:bg-white/30 focus:ring-2 focus:ring-brand focus:border-brand"> 
                  <Paperclip className='h-4 w-4'/> 
                  <span className='pl-2 pr-2 text-sm'>Attach</span> 
                </button> 
                
                <button type='button' className="flex items-center rounded-3xl border border-white px-2 py-1.5 text-white 
                hover:bg-white/30 focus:ring-2 focus:ring-brand focus:border-brand"> 
